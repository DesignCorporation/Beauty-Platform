...
export const getDefaultCurrency = () => 'PLN';
...
export const formatPrice = (amount, currency, options) => {
    ...
    if (typeof window !== 'undefined' && window.i18next) {
        ...
        locale = localeMap[window.i18next.language] || currencyData.defaultLocale;
    }
    const formatOptions = {
        style: 'currency',
...
export const useCurrency = () => {
    const [currency, setCurrencyState] = React.useState(getCurrentCurrency());
    React.useEffect(() => {
    ...
    return {
        ...
        changeCurrency,
        formatPrice: (amount, options) => formatPrice(amount, currency, options),
        supportedCurrencies
    };
};
