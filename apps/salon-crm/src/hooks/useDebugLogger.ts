...
export const useDebugLogger = (componentName: string, props: any) => {
  ...
  useEffect(() => {
    ...
    const changedProps = Object.entries(props).reduce((changes: any, [key, value]) => {
...
export const useEffectDebugger = (effectName: string, dependencies: any[]) => {
