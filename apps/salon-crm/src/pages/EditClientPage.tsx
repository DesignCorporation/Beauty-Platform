      ...
      <div className="p-6">
        <div className="max-w-2xl mx-auto">
          <div className="flex justify-center items-center py-12">
            ...
            <span className="ml-2 text-gray-600">Загрузка клиента...</span>
          </div>
        </div>
      </div>
    );
      ...
      <div className="p-6">
        <div className="max-w-2xl mx-auto">
          <div className="text-center py-12">
            ...
            <Button onClick={() => navigate('/clients')}>Вернуться к клиентам</Button>
          </div>
        </div>
      </div>
    );
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Редактировать клиента</h1>
